...
TBS="tb_loom_table tb_loom_ctrl"
SRCS="$LYNX_PKG $AXI_INTF ../src/hdl/loom_table.sv ../src/hdl/loom_ctrl.sv"

mkdir -p work && cd work

echo "== xvlog =="
xvlog -sv $(for f in $SRCS; do echo ../$f; done) ../tb_loom_table.sv ../tb_loom_ctrl.sv \
