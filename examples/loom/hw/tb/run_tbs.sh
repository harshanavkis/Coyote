...
TBS="tb_loom_table tb_loom_ctrl tb_loom_engine tb_loom_rx"
SRCS="$LYNX_PKG $AXI_INTF ../src/hdl/loom_table.sv ../src/hdl/loom_ctrl.sv ../src/hdl/loom_engine.sv ../src/hdl/loom_rx.sv"

mkdir -p work && cd work

echo "== xvlog =="
xvlog -sv $(for f in $SRCS; do echo ../$f; done) \
    ../tb_loom_table.sv ../tb_loom_ctrl.sv ../tb_loom_engine.sv ../tb_loom_rx.sv \
