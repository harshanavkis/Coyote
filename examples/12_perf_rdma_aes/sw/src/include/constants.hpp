/**
 * Example 12 - AES-GCM over RDMA. Constants and tag-slot bookkeeping, shared
 * by client and server so the two can never drift apart on the layout.
 */
...
#define N_THROUGHPUT_REPS 10

#define N_RUNS_DEFAULT              100
